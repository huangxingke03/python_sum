...
echo "=== 开始推送 系统配置文件（/home/huangxingke/work/file/讯飞切换版本/build_replace/sh/build_out_d01p.prop 到
 /system/build.prop ） 到系统 ==="
...
echo "📤  推送新 系统配置文件..."
adb_cmd push /home/huangxingke/work/file/讯飞切换版本/build_replace/sh/build_out_d01p.prop /system/build.prop
adb_cmd shell sync
...
echo "📤  推送新 Iflytek 资源..."
adb_cmd push /home/huangxingke/work/code/workCode/JETOUR_D01_IFLYTEK/D01P_INT/iflytek/res /iflytek/iflytek/res
...
echo "📤  推送新 APK..."
adb_cmd push /home/huangxingke/work/code/workCode/JETOUR_D01_IFLYTEK/D01P_INT/system/app /system/

echo "清除语音设置，讯飞侧应用缓存..."
adb_cmd shell pm clear com.iflytek.cutefly.speechclient.hmi
adb_cmd shell pm clear com.autolink.voicesetting

echo "清除语音设置，讯飞侧应用缓存后重启台架..."
adb_cmd reboot
